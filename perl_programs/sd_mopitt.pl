...
$avgfile = $rundir."MOPITT_Jan_2002_2017.nc";
...
$tracerlist = "RetrievedCOTotalColumnDay,RetrievedCOTotalColumnNight,RetrievedCOMixingRatioProfileDay,RetrievedCOSurfaceMixingRatioDay";
    ...
    for  $i (0..$dims-1) {
      ...
      $outfile = $rundir.@str_split[1]."_Jandiff.nc";
      print "$outfile\n";
      ...
      chomp(@final_diffs = `ls $rundir*_Jandiff.nc`);
      $sdfile = $rundir."MOPITT_2002_2017_Oct_sd.nc";
      print "--------------------------------------------------\n";
