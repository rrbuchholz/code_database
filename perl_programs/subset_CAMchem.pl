...
#------------------------------------
$tracerlist = "CO,O3,CH2O,ISOP,PAN,OH,NO2,NOX,NOY,HNO3,ALKNIT,ISOPNO3,MEG_ISOP";
#$tracerlist = "CO";
#for  $s (0..29) {
...
for  $i (2005..2015) {
  ...
  print "ncrcat -O -v date,datesec,time,lat,lon,P0,hyam,hybm,hyai,hybi,PDELDRY,$tracerlist -d lat,56,62 -d lon,117,123 @to_combine $outfile\n";
  `ncrcat -O -v date,datesec,time,lat,lon,P0,hyam,hybm,hyai,hybi,PDELDRY,$tracerlist -d lat,56,62 -d lon,117,123 @to_combine $outfile`;
}
